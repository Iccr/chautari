...
import 'package:chautari/view/tab/new_tab_view.dart';
...
class ChautariRouters {
  ...
  ChautariRouters() {
    _routers = [
      GetPage(name: RouteName.tab, page: () => NewTabView()),
      ...
      GetPage(name: RouteName.chat, page: () => Chat()),
      GetPage(name: RouteName.conversation, page: () => Conversation()),
      GetPage(
